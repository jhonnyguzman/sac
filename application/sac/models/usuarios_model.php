...
class Usuarios_Model extends CI_Model {
	...
	{
		//code here
		$this->db->insert('sys_usuarios', $options);
	...
	function get_m($options = array(),$flag=0)
	{
		...
		$this->db->from("sys_usuarios as u");
		$this->db->join("sys_perfiles as p","p.id = u.perfiles_id");
		$this->db->join("sys_tabgral as tg","tg.id = u.estado");
		$query = $this->db->get();
