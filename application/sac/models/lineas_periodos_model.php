...
class Lineas_periodos_Model extends CI_Model {
	...
	{
		//code here
		$this->db->insert('lineas_periodos', $options);
	...
	function edit_m($options = array())
	{
		...
		$this->db->update('lineas_periodos');
	...
	function delete_m($id)
	{
		//code here
		$this->db->where('id', $id);
		$this->db->delete('lineas_periodos');
	...
	function get_m($options = array(),$flag=0)
	{
		...
		$this->db->select("lp.*, lp.mes as mes_descripcion");
		$this->db->from("lineas_periodos as lp");
