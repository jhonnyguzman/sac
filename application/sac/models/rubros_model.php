...
class Rubros_Model extends CI_Model {
	...
	function edit_m($options = array())
	{
		...
		if(isset($options['es_monto_transferible']))
			$this->db->set('es_monto_transferible', $options['es_monto_transferible']);
	...
	function get_m($options = array(),$flag=0)
	{
		...
		if(isset($options['es_monto_transferible']))
			$this->db->where('es_monto_transferible', $options['es_monto_transferible']);
		if(isset($options['created_at']))
