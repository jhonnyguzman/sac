...
class Docentes_escuelas_Model extends CI_Model {
	...
	{
		//code here
		$this->db->insert('docentes_escuelas', $options);
	...
	function edit_m($options = array())
	{
		...
		$this->db->update('docentes_escuelas');
	...
	function delete_m($id)
	{
		//code here
		$this->db->where('id', $id);
		$this->db->delete('docentes_escuelas');
