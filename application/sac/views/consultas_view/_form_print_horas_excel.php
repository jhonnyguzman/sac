<div class="modal hide fade" id="modalSelectFieldToPrintExcel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
  	...
  	<div class="modal-body">
    	<form action="<?=base_url()?>consultas_controller/printHorasExcel_c/" method="post" name="formPrintExcel" id="formPrintExcel">
			<?=$this->load->view("consultas_view/_fieldstoprint_horas")?>
		</form>
  	</div>
