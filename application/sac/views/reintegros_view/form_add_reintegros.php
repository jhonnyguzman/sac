...
<form action="<?=base_url()?>reintegros_controller/add_c" method="post" name="formAddreintegros" id="formAddreintegros">
	<p>
	...
	<p>
		...
		<input type="text" name="persona_id" id="persona_id"></input>
	</p>
	<p>
	...
	<div class="botonera">
		<input type="submit" name="guardar" value="Guardar" class="crudtest-button" id="btn-save" onClick="submitData('formAddreintegros',new Array('right-content','right-content'))"></input>
