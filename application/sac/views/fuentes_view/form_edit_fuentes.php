...
<div class="span28">
	...
	<form action="<?=base_url()?>fuentes_controller/edit_c/<?=$fuentes->id?>" method="post" name="formEditfuentes" id="formEditfuentes" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" value="<?=$fuentes->created_at?>" name="created_at" id="created_at"  readonly></input>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="updated_at"><?=$this->config->item('updated_at')?>:</label>
			<div class="controls">
				<input type="text" value="<?=$fuentes->updated_at?>" name="updated_at" id="updated_at" readonly></input>
			</div>
		</div>
