...
<div class="span16">
	...
	<?=$this->load->view("default/_result_messages")?>
	 ...
	 <div class="row-fluid">
            <div class="span14">
            	<form action="<?=base_url()?>docentes_perfiles_controller/search_c" method="post" name="formSearchdocentes" id="formSearchdocentes" class="well form-search">
            ...
            <div class="span2">
            	<div class="btn-group">
				  ...
				  <ul class="dropdown-menu">
				    <?php if($flag['i']):?>
						<li><a href="<?=base_url()?>docentes_perfiles_controller/add_c" title='Nuevo'>Nuevo</a></li>
					<?php endif; ?>
				  </ul>
				</div>
            </div>
 ...
 <script>
    $(document).ready(function(){ 
        $("#result-list").load("<?=base_url()?>docentes_perfiles_controller/search_c");
    });
</script>
