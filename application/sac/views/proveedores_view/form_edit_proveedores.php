...
<div class="span28">
	...
	<form action="<?=base_url()?>proveedores_controller/edit_c/<?=$proveedores->id?>" method="post" 
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" value="<?=$proveedores->created_at?>" name="created_at" id="created_at"></input>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="nombre"><?=$this->config->item('updated_at')?>:</label>
			<div class="controls">
				<input type="text" value="<?=$proveedores->updated_at?>" name="updated_at" id="updated_at"></input>
			</div>
		</div>
