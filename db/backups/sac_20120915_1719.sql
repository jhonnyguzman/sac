...
CREATE TABLE  `sac_dev`.`docentes_escuelas` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `docentes_escuelas_docente_id` (`docente_id`),
  ...
  CONSTRAINT `docentes_escuelas_docente_id` FOREIGN KEY (`docente_id`) REFERENCES `docentes` (`id`)
...
INSERT INTO `sac_dev`.`docentes_escuelas` VALUES  (2,1,2,'2012-09-14 21:53:56','2012-09-15 03:58:50'),
 (3,2,3,'2012-09-15 01:07:21','2012-09-15 03:44:03'),
 (4,2,2,'2012-09-15 06:29:47','2012-09-15 06:29:47');
UNLOCK TABLES;
/*!40000 ALTER TABLE `docentes_escuelas` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`docentes_perfiles_escuelas`
--

DROP TABLE IF EXISTS `sac_dev`.`docentes_perfiles_escuelas`;
CREATE TABLE  `sac_dev`.`docentes_perfiles_escuelas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `docente_escuela_id` int(11) DEFAULT NULL,
  `perfil_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `docentes_perfiles_escuelas_docente_escuela_id` (`docente_escuela_id`),
  ...
  CONSTRAINT `docentes_perfiles_escuelas_docente_escuela_id` FOREIGN KEY (`docente_escuela_id`) REFERENCES `docentes_escuelas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`docentes_perfiles_escuelas`
--

/*!40000 ALTER TABLE `docentes_perfiles_escuelas` DISABLE KEYS */;
LOCK TABLES `docentes_perfiles_escuelas` WRITE;
INSERT INTO `sac_dev`.`docentes_perfiles_escuelas` VALUES  (10,2,1,'2012-09-14 21:53:56','2012-09-14 21:53:56'),
 (12,3,1,'2012-09-15 01:07:21','2012-09-15 01:07:21'),
 (13,3,3,'2012-09-15 01:07:21','2012-09-15 01:07:21'),
 (16,2,5,'2012-09-15 03:38:06','2012-09-15 03:38:06'),
 (17,3,4,'2012-09-15 03:44:03','2012-09-15 03:44:03'),
 (18,3,5,'2012-09-15 03:44:03','2012-09-15 03:44:03'),
 (19,3,6,'2012-09-15 03:44:03','2012-09-15 03:44:03'),
 (20,4,1,'2012-09-15 06:29:47','2012-09-15 06:29:47');
UNLOCK TABLES;
/*!40000 ALTER TABLE `docentes_perfiles_escuelas` ENABLE KEYS */;
...
CREATE TABLE  `sac_dev`.`lineas_accion_docentes` (
  ...
  `docente_perfil_escuela_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `lineas_accion_docentes_docente_perfil_escuela_id` (`docente_perfil_escuela_id`),
  ...
  CONSTRAINT `lineas_accion_docentes_docente_perfil_escuela_id` FOREIGN KEY (`docente_perfil_escuela_id`) REFERENCES `docentes_perfiles_escuelas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE  `sac_dev`.`lineas_accion_escuelas` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `lineas_accion_docentes_periodo_escuela_id` (`periodo_escuela_id`),
  ...
  CONSTRAINT `lineas_accion_docentes_periodo_escuela_id` FOREIGN KEY (`periodo_escuela_id`) REFERENCES `periodos_escuelas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
INSERT INTO `sac_dev`.`lineas_accion_escuelas` VALUES  (1,26,1,'2012-09-15 08:08:30','2012-09-15 08:08:30'),
 (2,26,2,'2012-09-15 08:34:59','2012-09-15 08:34:59');
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`sys_menu` VALUES  (1,'Administración',1,0,'1','2012-08-22 22:39:16',NULL,1),
 ...
 (18,'Horas institucionales',1,6,'0','2012-09-15 04:58:50','2012-09-15 04:58:50',NULL);
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`sys_permisos` VALUES  (1,'sys_usuarios',1,1,1,1,1,'2012-08-22 19:20:29','2012-09-05 04:44:07'),
 ...
 (25,'horas_institucionales',1,1,1,1,1,'2012-09-15 04:58:10','2012-09-15 04:58:10'),
