...
INSERT INTO `sac_dev`.`eventos` VALUES  (1,'Reunion familiar','Descripcion reunion familiar','2012-12-02','Av. Peron 3445',35,3700,1,'2012-11-27 19:52:53','2012-11-27 20:04:01'),
 (3,'Charla Consensual','Descripcion charla concensual','2012-12-06','Av. Mate de Luna 2343',60,2500,1,'2012-11-27 21:57:46','2012-11-27 21:57:46');
UNLOCK TABLES;
...
CREATE TABLE  `sac_dev`.`eventos_rubros` (
  ...
  KEY `eventos_rubros_rubro_id` (`rubro_id`),
  CONSTRAINT `eventos_rubros_evento_id` FOREIGN KEY (`evento_id`) REFERENCES `eventos` (`id`),
  CONSTRAINT `eventos_rubros_rubro_id` FOREIGN KEY (`rubro_id`) REFERENCES `rubros` (`id`)
...
INSERT INTO `sac_dev`.`eventos_rubros` VALUES  (1,1,1,'2012-11-27 21:36:31','2012-11-27 21:36:31'),
 (4,1,2,'2012-11-27 21:56:26','2012-11-27 21:56:26'),
 (5,1,3,'2012-11-27 21:56:28','2012-11-27 21:56:28'),
 (7,3,3,'2012-11-27 23:43:45','2012-11-27 23:43:45');
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`fuentes_rubros` VALUES  (1,1,1,'2012-11-28 01:06:01','2012-11-28 01:06:01'),
 ...
 (5,2,1,'2012-11-29 15:55:01','2012-11-29 15:55:01');
UNLOCK TABLES;
