...
--
-- Definition of table `sac_dev`.`adscriptos`
--

DROP TABLE IF EXISTS `sac_dev`.`adscriptos`;
CREATE TABLE  `sac_dev`.`adscriptos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `proyecto_persona_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `adscriptos_escuela_id` (`escuela_id`),
  CONSTRAINT `adscriptos_escuela_id` FOREIGN KEY (`escuela_id`) REFERENCES `escuelas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`adscriptos`
--

/*!40000 ALTER TABLE `adscriptos` DISABLE KEYS */;
LOCK TABLES `adscriptos` WRITE;
INSERT INTO `sac_dev`.`adscriptos` VALUES  (1,2,2,20,1,'2012-11-26 19:05:31','2012-11-29 15:56:59'),
 (2,4,2,0,1,'2012-11-28 18:58:46','2012-11-28 18:58:46'),
 (3,5,2,0,1,'2012-11-28 19:07:29','2012-11-28 19:07:29'),
 (4,6,2,0,1,'2012-11-28 19:08:46','2012-11-28 19:08:46'),
 (5,7,6,200,1,'2012-11-28 19:10:54','2012-11-28 19:10:54'),
 (6,14,2,343,1,'2012-12-10 22:40:32','2012-12-10 22:40:32'),
 (7,16,2,343,1,'2012-12-10 22:44:31','2012-12-10 22:44:31'),
 (8,17,2,34,1,'2012-12-10 22:46:20','2012-12-10 22:46:20');
UNLOCK TABLES;
/*!40000 ALTER TABLE `adscriptos` ENABLE KEYS */;
...
--
-- Definition of table `sac_dev`.`contratados`
--

DROP TABLE IF EXISTS `sac_dev`.`contratados`;
CREATE TABLE  `sac_dev`.`contratados` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `proyecto_persona_id` int(11) NOT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `contratados_proyecto_persona_id` (`proyecto_persona_id`),
  CONSTRAINT `contratados_proyecto_persona_id` FOREIGN KEY (`proyecto_persona_id`) REFERENCES `proyectos_personas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`contratados`
--

/*!40000 ALTER TABLE `contratados` DISABLE KEYS */;
LOCK TABLES `contratados` WRITE;
INSERT INTO `sac_dev`.`contratados` VALUES  (4,8,'2012-11-20','2012-12-20',3500,30,'algo aqui',1,'2012-11-28 19:15:37','2012-11-29 15:56:49');
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`docentes` VALUES  (1,40114481,'Sanchez','Marta','3814952545','marta@gmail.com',1,'2012-08-27 23:37:05','2012-11-06 18:37:24'),
 (2,33785658,'Alfaro','Matias','3434434','matias@gmail.com',1,'2012-08-27 23:48:51','2012-11-28 17:09:30'),
...
INSERT INTO `sac_dev`.`docentes_titulos` VALUES  (1,5,1,NULL,'2012-10-05 15:47:14'),
 ...
 (22,2,3,NULL,'2012-11-28 17:09:31');
UNLOCK TABLES;
/*!40000 ALTER TABLE `docentes_titulos` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`ejes`
--

DROP TABLE IF EXISTS `sac_dev`.`ejes`;
CREATE TABLE  `sac_dev`.`ejes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sac_dev`.`ejes`
--

/*!40000 ALTER TABLE `ejes` DISABLE KEYS */;
LOCK TABLES `ejes` WRITE;
INSERT INTO `sac_dev`.`ejes` VALUES  (1,'Eje 1','Descripcion eje1',1,'2012-11-10 22:21:24','2012-11-10 22:21:24');
UNLOCK TABLES;
...
--
-- Definition of table `sac_dev`.`eventos`
--

DROP TABLE IF EXISTS `sac_dev`.`eventos`;
CREATE TABLE  `sac_dev`.`eventos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) DEFAULT NULL,
  `descripcion` text,
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  `monto_presupuestado` float DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `eventos_proyecto_id` (`proyecto_id`),
  CONSTRAINT `eventos_proyecto_id` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`eventos`
--

/*!40000 ALTER TABLE `eventos` DISABLE KEYS */;
LOCK TABLES `eventos` WRITE;
INSERT INTO `sac_dev`.`eventos` VALUES  (1,'Reunion familiar','Descripcion reunion familiar','2012-12-02','Av. Peron 3445',35,3700,1,'2012-11-27 19:52:53','2012-11-27 20:04:01',NULL),
 (3,'Charla Consensual','Descripcion charla concensual','2012-12-06','Av. Mate de Luna 2343',60,2500,1,'2012-11-27 21:57:46','2012-11-27 21:57:46',NULL),
 (4,'Renion','Descripción aqui','2012-12-22','San Miguelo 345',20,NULL,1,'2012-12-21 20:56:25','2012-12-21 20:56:25',2000);
UNLOCK TABLES;
/*!40000 ALTER TABLE `eventos` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`eventos_rubros`
--

DROP TABLE IF EXISTS `sac_dev`.`eventos_rubros`;
CREATE TABLE  `sac_dev`.`eventos_rubros` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `evento_id` int(11) NOT NULL,
  `fuente_rubro_id` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  `costo` float DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `eventos_rubros_evento_id` (`evento_id`),
  KEY `eventos_rubros_fuente_rubro_id` (`fuente_rubro_id`),
  CONSTRAINT `eventos_rubros_fuente_rubro_id` FOREIGN KEY (`fuente_rubro_id`) REFERENCES `fuentes_rubros` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `eventos_rubros_evento_id` FOREIGN KEY (`evento_id`) REFERENCES `eventos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`eventos_rubros`
--

/*!40000 ALTER TABLE `eventos_rubros` DISABLE KEYS */;
LOCK TABLES `eventos_rubros` WRITE;
INSERT INTO `sac_dev`.`eventos_rubros` VALUES  (1,1,7,'2012-12-21 22:29:46','2012-12-21 23:22:57',600);
UNLOCK TABLES;
/*!40000 ALTER TABLE `eventos_rubros` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`facturas`
--

DROP TABLE IF EXISTS `sac_dev`.`facturas`;
CREATE TABLE  `sac_dev`.`facturas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `facturas_proveedor_id` (`proveedor_id`),
  KEY `facturas_tabgral_id` (`estado`),
  CONSTRAINT `facturas_tabgral_id` FOREIGN KEY (`estado`) REFERENCES `sys_tabgral` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `facturas_proveedor_id` FOREIGN KEY (`proveedor_id`) REFERENCES `proveedores` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`facturas`
--

/*!40000 ALTER TABLE `facturas` DISABLE KEYS */;
LOCK TABLES `facturas` WRITE;
INSERT INTO `sac_dev`.`facturas` VALUES  (1,1200,'2012-12-28',6780,9,'',1,'2012-11-28 16:01:41','2012-11-28 16:01:41'),
 (2,1523,'2012-12-28',214,9,'',1,'2012-11-28 16:21:43','2012-11-28 18:23:01');
UNLOCK TABLES;
/*!40000 ALTER TABLE `facturas` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`facturas_lineas`
--

DROP TABLE IF EXISTS `sac_dev`.`facturas_lineas`;
CREATE TABLE  `sac_dev`.`facturas_lineas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `facturas_lineas_factura_id` (`factura_id`),
  CONSTRAINT `facturas_lineas_factura_id` FOREIGN KEY (`factura_id`) REFERENCES `facturas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`facturas_lineas`
--

/*!40000 ALTER TABLE `facturas_lineas` DISABLE KEYS */;
LOCK TABLES `facturas_lineas` WRITE;
INSERT INTO `sac_dev`.`facturas_lineas` VALUES  (1,'Concepto 1',52.25,5,261.25,1,'2012-11-28 16:01:41','2012-11-28 16:01:41'),
 (2,'Concepto 2',125.5,52,6526,1,'2012-11-28 16:01:42','2012-11-28 16:01:42'),
 (3,'Concepto 3',45,2,90,1,'2012-11-28 16:01:42','2012-11-28 16:01:42'),
 (35,'dds',34,3,102,2,'2012-11-28 18:23:02','2012-11-28 18:23:01'),
 (36,'teest',3,4,12,2,'2012-11-28 18:23:02','2012-11-28 18:23:02'),
 (37,'rdds',10,10,100,2,'2012-11-28 18:23:02','2012-11-28 18:23:02');
UNLOCK TABLES;
/*!40000 ALTER TABLE `facturas_lineas` ENABLE KEYS */;
...
CREATE TABLE  `sac_dev`.`fondo_comun` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fondo_comun_periodo_escuela_id` (`periodo_escuela_id`),
  CONSTRAINT `fondo_comun_periodo_escuela_id` FOREIGN KEY (`periodo_escuela_id`) REFERENCES `periodos_escuelas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
--
-- Definition of table `sac_dev`.`fuentes`
--

DROP TABLE IF EXISTS `sac_dev`.`fuentes`;
CREATE TABLE  `sac_dev`.`fuentes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
...
--
-- Dumping data for table `sac_dev`.`fuentes`
--

/*!40000 ALTER TABLE `fuentes` DISABLE KEYS */;
LOCK TABLES `fuentes` WRITE;
INSERT INTO `sac_dev`.`fuentes` VALUES  (1,'Gobierno Nacional','2012-11-11 00:52:07','2012-11-11 00:52:11'),
 (2,'Gobierno Provincial','2012-12-21 22:04:08','2012-12-21 22:04:08');
UNLOCK TABLES;
/*!40000 ALTER TABLE `fuentes` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`fuentes_lineas`
--

DROP TABLE IF EXISTS `sac_dev`.`fuentes_lineas`;
CREATE TABLE  `sac_dev`.`fuentes_lineas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fuente_id` int(11) NOT NULL,
  `anio` int(11) DEFAULT NULL,
  `monto_global` float DEFAULT NULL,
  `monto_especial` float DEFAULT NULL,
  `estado` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fuentes_lineas_fuente_id` (`fuente_id`),
  KEY `fuentes_lineas_tabgral_id` (`estado`),
  CONSTRAINT `fuentes_lineas_tabgral_id` FOREIGN KEY (`estado`) REFERENCES `sys_tabgral` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fuentes_lineas_fuente_id` FOREIGN KEY (`fuente_id`) REFERENCES `fuentes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`fuentes_lineas`
--

/*!40000 ALTER TABLE `fuentes_lineas` DISABLE KEYS */;
LOCK TABLES `fuentes_lineas` WRITE;
INSERT INTO `sac_dev`.`fuentes_lineas` VALUES  (1,1,2011,800000,900000,13,'2012-11-29 16:45:08','2012-11-29 17:14:40'),
 (3,1,2012,900000,800000,12,'2012-11-29 17:18:10','2012-11-29 17:18:10');
UNLOCK TABLES;
/*!40000 ALTER TABLE `fuentes_lineas` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`fuentes_rubros`
--

DROP TABLE IF EXISTS `sac_dev`.`fuentes_rubros`;
CREATE TABLE  `sac_dev`.`fuentes_rubros` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fuentes_rubros_rubro_id` (`fuente_id`),
  CONSTRAINT `fuentes_rubros_rubro_id` FOREIGN KEY (`fuente_id`) REFERENCES `rubros` (`id`),
  CONSTRAINT `fuentes_rubros_fuente_id` FOREIGN KEY (`fuente_id`) REFERENCES `fuentes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`fuentes_rubros`
--

/*!40000 ALTER TABLE `fuentes_rubros` DISABLE KEYS */;
LOCK TABLES `fuentes_rubros` WRITE;
INSERT INTO `sac_dev`.`fuentes_rubros` VALUES  (1,1,1,'2012-11-28 01:06:01','2012-11-28 01:06:01'),
 (4,3,1,'2012-11-28 01:11:54','2012-11-28 01:11:54'),
 (6,1,2,'2012-12-21 22:04:13','2012-12-21 22:04:13'),
 (7,3,2,'2012-12-21 22:04:17','2012-12-21 22:04:17');
UNLOCK TABLES;
/*!40000 ALTER TABLE `fuentes_rubros` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`lineas`
--

DROP TABLE IF EXISTS `sac_dev`.`lineas`;
CREATE TABLE  `sac_dev`.`lineas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) DEFAULT NULL,
  `descripcion` text,
  `habilitado` int(11) DEFAULT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `lineas_eje_id` (`eje_id`),
  CONSTRAINT `lineas_eje_id` FOREIGN KEY (`eje_id`) REFERENCES `ejes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`lineas`
--

/*!40000 ALTER TABLE `lineas` DISABLE KEYS */;
LOCK TABLES `lineas` WRITE;
INSERT INTO `sac_dev`.`lineas` VALUES  (1,'Linea 1','Descripcion Linea 1',1,1,'2012-11-10 23:23:40','2012-11-10 23:23:52');
UNLOCK TABLES;
...
CREATE TABLE  `sac_dev`.`lineas_accion_docentes` (
  ...
  KEY `lineas_accion_docentes_fondo_comun_id` (`fondo_comun_id`),
  ...
  CONSTRAINT `lineas_accion_docentes_fondo_comun_id` FOREIGN KEY (`fondo_comun_id`) REFERENCES `fondo_comun` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Definition of table `sac_dev`.`personas`
--

DROP TABLE IF EXISTS `sac_dev`.`personas`;
CREATE TABLE  `sac_dev`.`personas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dni` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `sac_dev`.`personas`
--

/*!40000 ALTER TABLE `personas` DISABLE KEYS */;
LOCK TABLES `personas` WRITE;
INSERT INTO `sac_dev`.`personas` VALUES  (1,40114482,'Ferrari','Martin','Muñecas 344','381459448','','',1,'2012-11-10 23:49:17','2012-11-29 18:03:14'),
 (2,33525452,'Fernandez','Hector','Miguel Angel 234','381458525','','',1,'2012-11-26 17:49:01','2012-11-26 17:49:01');
UNLOCK TABLES;
/*!40000 ALTER TABLE `personas` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`proveedores`
--

DROP TABLE IF EXISTS `sac_dev`.`proveedores`;
CREATE TABLE  `sac_dev`.`proveedores` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sac_dev`.`proveedores`
--

/*!40000 ALTER TABLE `proveedores` DISABLE KEYS */;
LOCK TABLES `proveedores` WRITE;
INSERT INTO `sac_dev`.`proveedores` VALUES  (1,'20332562512','Infosys','Av. Além 1250','3814978545','','contact@infosys.com',1,'2012-11-11 01:28:06','2012-11-29 18:07:50');
UNLOCK TABLES;
/*!40000 ALTER TABLE `proveedores` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`proveedores_rubros`
--

DROP TABLE IF EXISTS `sac_dev`.`proveedores_rubros`;
CREATE TABLE  `sac_dev`.`proveedores_rubros` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `proveedores_rubros_proveedor_id` (`proveedor_id`),
  KEY `proveedores_rubros_rubro_id` (`rubro_id`),
  CONSTRAINT `proveedores_rubros_rubro_id` FOREIGN KEY (`rubro_id`) REFERENCES `rubros` (`id`),
  CONSTRAINT `proveedores_rubros_proveedor_id` FOREIGN KEY (`proveedor_id`) REFERENCES `proveedores` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`proveedores_rubros`
--

/*!40000 ALTER TABLE `proveedores_rubros` DISABLE KEYS */;
LOCK TABLES `proveedores_rubros` WRITE;
INSERT INTO `sac_dev`.`proveedores_rubros` VALUES  (1,1,1,'2012-11-28 12:21:29','2012-11-28 12:21:29'),
 (4,1,3,'2012-11-28 12:28:12','2012-11-28 12:28:12'),
 (6,1,2,'2012-11-29 15:52:32','2012-11-29 15:52:32');
UNLOCK TABLES;
/*!40000 ALTER TABLE `proveedores_rubros` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`proyectos`
--

DROP TABLE IF EXISTS `sac_dev`.`proyectos`;
CREATE TABLE  `sac_dev`.`proyectos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) DEFAULT NULL,
  `descripcion` text,
  `habilitado` int(11) DEFAULT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `proyectos_linea_id` (`linea_id`),
  CONSTRAINT `proyectos_linea_id` FOREIGN KEY (`linea_id`) REFERENCES `lineas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`proyectos`
--

/*!40000 ALTER TABLE `proyectos` DISABLE KEYS */;
LOCK TABLES `proyectos` WRITE;
INSERT INTO `sac_dev`.`proyectos` VALUES  (1,'Proyecto 1','Descripcion proyecto 1',1,1,'2012-11-10 23:34:14','2012-11-10 23:34:18');
UNLOCK TABLES;
/*!40000 ALTER TABLE `proyectos` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`proyectos_fuentes_lineas`
--

DROP TABLE IF EXISTS `sac_dev`.`proyectos_fuentes_lineas`;
CREATE TABLE  `sac_dev`.`proyectos_fuentes_lineas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `proyecto_id` int(11) NOT NULL,
  `fuente_linea_id` int(11) NOT NULL,
  `monto_presupuestado` float DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `proyectos_fuentes_lineas_fuente_linea_id` (`fuente_linea_id`),
  KEY `proyectos_fuentes_lineas_proyecto_id` (`proyecto_id`),
  CONSTRAINT `proyectos_fuentes_lineas_proyecto_id` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `proyectos_fuentes_lineas_fuente_linea_id` FOREIGN KEY (`fuente_linea_id`) REFERENCES `fuentes_lineas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`proyectos_fuentes_lineas`
--

/*!40000 ALTER TABLE `proyectos_fuentes_lineas` DISABLE KEYS */;
LOCK TABLES `proyectos_fuentes_lineas` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `proyectos_fuentes_lineas` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`proyectos_personas`
--

DROP TABLE IF EXISTS `sac_dev`.`proyectos_personas`;
CREATE TABLE  `sac_dev`.`proyectos_personas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `proyecto_id` int(11) NOT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `proyectos_personas_persona_id` (`persona_id`),
  KEY `proyectos_personas_proyecto_id` (`proyecto_id`),
  CONSTRAINT `proyectos_personas_proyecto_id` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  CONSTRAINT `proyectos_personas_persona_id` FOREIGN KEY (`persona_id`) REFERENCES `personas` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`proyectos_personas`
--

/*!40000 ALTER TABLE `proyectos_personas` DISABLE KEYS */;
LOCK TABLES `proyectos_personas` WRITE;
INSERT INTO `sac_dev`.`proyectos_personas` VALUES  (2,1,1,'2012-11-26 19:05:31','2012-11-29 15:56:59'),
 (8,1,2,'2012-11-28 19:15:37','2012-11-29 15:56:48'),
 (17,1,2,'2012-12-10 22:46:20','2012-12-10 22:46:20');
UNLOCK TABLES;
/*!40000 ALTER TABLE `proyectos_personas` ENABLE KEYS */;


--
-- Definition of table `sac_dev`.`reintegros`
--

DROP TABLE IF EXISTS `sac_dev`.`reintegros`;
CREATE TABLE  `sac_dev`.`reintegros` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `reintegros_persona_id` (`persona_id`),
  KEY `reintegros_tabgral_id` (`tipo`),
  CONSTRAINT `reintegros_tabgral_id` FOREIGN KEY (`tipo`) REFERENCES `sys_tabgral` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reintegros_persona_id` FOREIGN KEY (`persona_id`) REFERENCES `personas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sac_dev`.`reintegros`
--
...
--
-- Definition of table `sac_dev`.`rubros`
--

DROP TABLE IF EXISTS `sac_dev`.`rubros`;
CREATE TABLE  `sac_dev`.`rubros` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) DEFAULT NULL,
  `es_monto_transferible` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `sac_dev`.`rubros`
--

/*!40000 ALTER TABLE `rubros` DISABLE KEYS */;
LOCK TABLES `rubros` WRITE;
INSERT INTO `sac_dev`.`rubros` VALUES  (1,'Rubro 1',0,'2012-11-27 20:20:53','2012-11-27 20:25:14'),
 (2,'Rubro 2',1,'2012-11-27 20:25:30','2012-11-27 20:25:30'),
 (3,'Rubro 3',1,'2012-11-27 20:25:41','2012-11-27 20:25:41');
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`sys_grupos_tabgral` VALUES  (1,'estados generales','2012-08-22 18:49:01','0000-00-00 00:00:00'),
 ...
 (5,'Estados de facturas','2012-11-28 15:44:48','0000-00-00 00:00:00'),
 (6,'Estado de fuentes lineas','2012-11-29 16:36:54','0000-00-00 00:00:00');
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`sys_menu` VALUES  (1,'Administración',1,0,'1','2012-08-22 22:39:16',NULL,1),
 ...
 (21,'Gastos',1,0,'0','2012-11-10 22:10:05','2012-11-10 22:10:05',NULL),
 (22,'Ejes',1,21,'0','2012-11-10 22:10:26','2012-11-10 22:10:26',NULL),
 (23,'Lineas',1,21,'0','2012-11-10 22:11:58','2012-11-10 22:11:58',NULL),
 (24,'Proyectos',1,21,'0','2012-11-10 22:12:19','2012-11-10 22:12:19',NULL),
 (25,'Personas',1,21,'0','2012-11-10 22:13:00','2012-11-10 22:13:00',NULL),
 (26,'Fuentes',1,21,'0','2012-11-11 00:27:16','2012-11-11 00:27:16',NULL),
 (27,'Proveedores',1,21,'0','2012-11-11 01:24:30','2012-11-11 01:24:30',NULL),
 (28,'Rubros',1,21,'0','2012-11-27 20:18:15','2012-11-27 20:18:52',NULL),
 (29,'Facturas',1,21,'0','2012-11-28 12:30:12','2012-11-28 12:30:32',NULL);
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`sys_perfil` VALUES  (1,1,1,1,'2012-08-22 22:40:40','0000-00-00 00:00:00'),
 ...
 (30,21,1,1,'2012-11-10 22:10:35','2012-11-10 22:10:35'),
 (31,22,1,1,'2012-11-10 22:10:38','2012-11-10 22:10:38'),
 (32,25,1,1,'2012-11-10 22:13:08','2012-11-10 22:13:08'),
 (33,24,1,1,'2012-11-10 22:13:11','2012-11-10 22:13:11'),
 (34,23,1,1,'2012-11-10 22:13:13','2012-11-10 22:13:13'),
 (35,26,1,1,'2012-11-11 00:27:23','2012-11-11 00:27:23'),
 (36,27,1,1,'2012-11-11 01:24:38','2012-11-11 01:24:38'),
 (37,28,1,1,'2012-11-27 20:18:33','2012-11-27 20:18:33'),
 (38,29,1,1,'2012-11-28 12:30:19','2012-11-28 12:30:19');
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`sys_permisos` VALUES  (1,'sys_usuarios',1,1,1,1,1,'2012-08-22 19:20:29','2012-10-11 06:14:47'),
 ...
 (33,'ejes',1,1,1,1,1,'2012-11-10 22:09:38','2012-11-10 22:09:38'),
 (34,'lineas',1,1,1,1,1,'2012-11-10 23:23:19','2012-11-10 23:23:19'),
 (35,'proyectos',1,1,1,1,1,'2012-11-10 23:33:41','2012-11-10 23:33:41'),
 (36,'personas',1,1,1,1,1,'2012-11-10 23:47:55','2012-11-10 23:47:55'),
 (37,'fuentes',1,1,1,1,1,'2012-11-11 00:26:47','2012-11-11 00:26:47'),
 (38,'proveedores',1,1,1,1,1,'2012-11-11 01:24:58','2012-11-11 01:24:58'),
 (39,'proyectos_personas',1,1,1,1,1,'2012-11-15 03:13:03','2012-11-15 03:13:03'),
 (40,'adscriptos',1,1,1,1,1,'2012-11-26 19:06:32','2012-11-26 19:06:32'),
 (41,'contratados',1,1,1,1,1,'2012-11-26 19:06:42','2012-11-26 19:06:42'),
 (42,'eventos',1,1,1,1,1,'2012-11-27 19:30:31','2012-11-27 19:33:15'),
 (43,'eventos_rubros',1,1,1,1,1,'2012-11-27 19:30:43','2012-11-27 23:52:02'),
 (44,'rubros',1,1,1,1,1,'2012-11-27 20:17:50','2012-11-27 20:17:50'),
 (45,'fuentes_rubros',1,1,1,1,1,'2012-11-28 00:56:07','2012-11-28 00:59:01'),
 (46,'proveedores_rubros',1,1,1,1,1,'2012-11-28 12:12:25','2012-11-28 12:12:25'),
 (47,'facturas',1,1,1,1,1,'2012-11-28 12:29:39','2012-11-28 12:29:39'),
 (48,'fuentes_lineas',1,1,1,1,1,'2012-11-28 12:29:46','2012-11-28 12:29:46');
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`sys_tabgral` VALUES  (1,'Habilitado',1,'2012-08-22 18:49:30','0000-00-00 00:00:00'),
 ...
 (9,'Sin pagar',5,'2012-11-28 15:45:31','0000-00-00 00:00:00'),
 (10,'Pagada',5,'2012-11-28 15:45:31','0000-00-00 00:00:00'),
 (11,'Cancelada',5,'2012-11-28 15:45:49','0000-00-00 00:00:00'),
 (12,'Activa',6,'2012-11-29 16:37:26','0000-00-00 00:00:00'),
 (13,'Historico',6,'2012-11-29 16:37:26','0000-00-00 00:00:00');
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`sys_vinculos` VALUES  (1,1,'#','2012-08-22 22:40:03','0000-00-00 00:00:00'),
 ...
 (21,21,'#','2012-11-10 22:10:05','0000-00-00 00:00:00'),
 (22,22,'ejes_controller/index','2012-11-10 22:10:26','0000-00-00 00:00:00'),
 (23,23,'lineas_controller/index','2012-11-10 22:11:58','0000-00-00 00:00:00'),
 (24,24,'proyectos_controller/index','2012-11-10 22:12:19','0000-00-00 00:00:00'),
 (25,25,'personas_controller/index','2012-11-10 22:13:00','0000-00-00 00:00:00'),
 (26,26,'fuentes_controller/index','2012-11-11 00:27:16','0000-00-00 00:00:00'),
 (27,27,'proveedores_controller/index','2012-11-11 01:24:31','0000-00-00 00:00:00'),
 (28,28,'rubros_controller/index','2012-11-27 20:18:15','0000-00-00 00:00:00'),
 (29,29,'facturas_controller/index','2012-11-28 12:30:13','0000-00-00 00:00:00');
UNLOCK TABLES;
