...
INSERT INTO `sac_dev`.`docentes` VALUES  (1,40114481,'Marta ','Sanchez','492554','marta@gmail.com',1,'2012-08-27 23:37:05',NULL),
 ...
 (3,123456789,'Quinteros','Jorge','44223','mjhg@jhgff.com',1,'2012-09-02 18:46:38','2012-09-02 23:46:38');
UNLOCK TABLES;
...
CREATE TABLE  `sac_dev`.`docentes_perfiles` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `docentes_perfiles_docente_id` (`docente_id`),
  KEY `fk_docentes_perfiles_perfiles_id` (`perfil_id`),
  CONSTRAINT `fk_docentes_perfiles_perfiles_id` FOREIGN KEY (`perfil_id`) REFERENCES `perfiles` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `docentes_perfiles_docente_id` FOREIGN KEY (`docente_id`) REFERENCES `docentes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
...
INSERT INTO `sac_dev`.`docentes_perfiles` VALUES  (1,1,1,'2012-09-16 07:52:40','2012-09-16 07:52:40'),
 (2,2,2,'2012-09-16 08:02:47','2012-09-16 08:02:47'),
 (3,3,5,'2012-09-16 21:43:23','2012-09-16 21:43:23');
UNLOCK TABLES;
...
CREATE TABLE  `sac_dev`.`docentes_titulos` (
  ...
  CONSTRAINT `fk_docentes_titulos_docentes` FOREIGN KEY (`docente_id`) REFERENCES `docentes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `sac_dev`.`escuelas` VALUES  (2,900000000,'Manuel Belgrano','Belgrano 2345','381458558','mb@gmail.com',1,43,1,'2012-08-29 01:38:06','2012-09-15 04:00:06',5),
...
INSERT INTO `sac_dev`.`lineas_accion` VALUES  (1,'Linea de accion','linea de accion 1',1,5,'2012-08-31 15:57:33','2012-09-15 05:47:21'),
 (2,'Capacitación','',1,5,'2012-09-15 05:47:44','2012-09-15 05:47:44'),
 (3,'Prevenciones','',1,6,'2012-09-15 05:48:16','2012-09-15 05:48:16');
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`lineas_accion_docentes` VALUES  (1,2,1,'2012-09-16 07:52:40','2012-09-16 07:52:40',4),
 (2,2,2,'2012-09-16 08:02:47','2012-09-16 08:02:47',5),
 (3,3,3,'2012-09-16 21:43:23','2012-09-16 21:43:23',5);
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`lineas_accion_escuelas` VALUES  (2,23,2,'2012-09-16 06:39:42','2012-09-16 06:39:42'),
 (3,22,1,'2012-09-16 08:05:55','2012-09-16 08:05:55');
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`lineas_periodos_escuelas` VALUES  (12,27,1,70,'2012-09-16 05:25:56','2012-09-16 05:25:56',2009,70),
 (13,27,2,70,'2012-09-16 05:25:56','2012-09-16 05:25:56',2009,70),
 (14,27,3,70,'2012-09-16 05:25:56','2012-09-16 05:25:56',2009,70),
 (15,27,4,70,'2012-09-16 05:25:56','2012-09-16 05:25:56',2009,70),
 (16,27,5,70,'2012-09-16 05:25:56','2012-09-16 05:25:56',2009,70),
 (17,27,6,70,'2012-09-16 05:25:56','2012-09-16 05:25:56',2009,70),
 (18,27,7,70,'2012-09-16 05:25:56','2012-09-16 05:25:56',2009,70),
 (19,27,8,70,'2012-09-16 05:25:56','2012-09-16 05:25:56',2009,70),
 (20,27,9,70,'2012-09-16 05:25:56','2012-09-16 05:25:56',2009,70),
 (21,27,10,70,'2012-09-16 05:25:56','2012-09-16 05:25:56',2009,70),
 (22,28,10,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2009,68),
 (23,28,11,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2009,68),
 (24,28,12,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2009,68),
 (25,28,1,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2010,68),
 (26,28,2,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2010,68),
 (27,28,3,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2010,68),
 (28,28,4,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2010,68),
 (29,28,5,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2010,68),
 (30,28,6,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2010,68),
 (31,28,7,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2010,68),
 (32,28,8,68,'2012-09-16 05:27:37','2012-09-16 05:27:37',2010,68);
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`periodos` VALUES  (9,'2009-01-01 00:00:00','2009-10-01 00:00:00',250,'2012-09-16 05:25:14','2012-09-16 05:25:14',4),
 (10,'2009-10-01 00:00:00','2010-08-01 00:00:00',350,'2012-09-16 05:27:08','2012-09-16 05:27:08',3);
UNLOCK TABLES;
...
INSERT INTO `sac_dev`.`periodos_escuelas` VALUES  (27,9,2,5252,1552,700,'2012-09-16 05:25:56','2012-09-16 05:25:56',4),
 (28,10,2,4125,5585,750,'2012-09-16 05:27:37','2012-09-16 05:27:37',3);
UNLOCK TABLES;
