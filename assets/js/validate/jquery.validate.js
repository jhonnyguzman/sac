...
$.extend($.validator, {
	...
	messages: {
		...
		dateITA: "Ingresa una fecha válida.",
		number: "Ingrese un número válido.",
		digits: "Ingrese sólo dígitos.",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Ingresa el mismo valor que el campo anterior.",
		...
		rangelength: $.validator.format("Ingrese entre {0} y {1} caracteres de longitud."),
